...
public class PmsProductAttributeController {
    ...
    public CommonResult get(@PathVariable("id") Long id) {
        PmsProductAttribute attribute = attributeService.getByAttributeId(id);
        if (attribute != null) {
    ...
    @RequestMapping("/attribute/{cid}")
    public CommonResult attribute(@PathVariable("cid") Long cid) {
        List<PmsProductAttributeInfo> attriInfo = attributeService.getByAttributeId(cid);
